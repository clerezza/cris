...
/**
 * A VirtualProperty is a function that returns a string given a RdfTerm. This might be either
...
public abstract class VirtualProperty {
     ...
     */
    public Set<IRI> getBaseProperties() {
     ...
     */
    protected abstract List<IRI> pathToIndexedResource(IRI property);
}
