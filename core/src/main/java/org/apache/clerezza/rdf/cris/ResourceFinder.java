 ...
 */
 public abstract class ResourceFinder {
     ...
     * @throws ParseException when the resulting query is illegal.
     */
    public abstract List<BlankNodeOrIRI> findResources(List<? extends Condition> conditions, 
     ...
     * @throws ParseException when the resulting query is illegal.
     */
    public List<BlankNodeOrIRI> findResources(IRI property, String pattern) 
            throws ParseException {
     ...
     * @throws ParseException when the resulting query is illegal.
     */
    public List<BlankNodeOrIRI> findResources(IRI property, String pattern, boolean escapePattern)
            throws ParseException {
     ...
     * @throws ParseException when the resulting query is illegal.
     */
    public List<BlankNodeOrIRI> findResources(VirtualProperty property, String pattern) 
            throws ParseException {
        return findResources(property, pattern, false);
    }
