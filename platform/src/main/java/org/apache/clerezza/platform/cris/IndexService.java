...
public class IndexService extends ResourceFinder {
    ...
    IRI definitionGraphUri = new IRI("http://zz.localhost/cris.definitions.graph");
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            definitionGraph = tcManager.getGraph(definitionGraphUri);
        } catch (NoSuchEntityException ex) {
            definitionGraph = tcManager.createGraph(definitionGraphUri);
        }
    ...
    @Override
    public List<BlankNodeOrIRI> findResources(IRI uriRef, String pattern) {
        try {
    ...
    public void addDefintion(IRI propertyType, List<IRI> predicates) {
    ...
    public void addDefinitionVirtual(IRI propertyType, List<VirtualProperty> predicates) {
        Lock lock = definitionGraph.getLock().writeLock();
        lock.lock();
        try {
    ...
    public void deleteDefintion(IRI propertyType) {
        Lock lock = definitionGraph.getLock().writeLock();
        lock.lock();
        try {
